...
<input type='hidden' name='tablenum' value='t1'><input type=submit value='Book'><br>TABLE 1</td>
...
?>
<td border="1" align="center" bgcolor="green">
<input type='hidden' name='tablenum' value='t2'><input type=submit value='Book'><br>TABLE 2</td>
<?php else: ?>
...
?>
<td border="1" align="center" bgcolor="green">
<input type='hidden' name='tablenum' value='t3'><input type=submit value='Book'><br>TABLE 3</td>
<?php else: ?>
...
?>
<td border="1" align="center" bgcolor="green">
<input type='hidden' name='tablenum' value='t4'><input type=submit value='Book'><br>TABLE 4</td>
<?php else: ?>
...
?>
<td border=1 align="center" bgcolor="green">
<input type='hidden' name='tablenum' value='t5'><input type=submit value='Book'><br>TABLE 5</td>
<?php else: ?>
...
?>
<td border="1" align="center" bgcolor="green">
<input type='hidden' name='tablenum' value='t6'><input type=submit value='Book'><br>TABLE 6</td>
<?php } else { ?>
...
if($vac=="Yes"):?>
<td border="1" align="center" bgcolor="green">
<input type='hidden' name='tablenum' value='t7'><input type=submit value='Book'><br>TABLE 7</td>
<?php else: ?>
...
?>
<td border=1 align="center" bgcolor="green">
<input type='hidden' name='tablenum' value='t8'><input type=submit value='Book'><TABLE 8</td>
<?php } else{ ?>
...
?>
<td border="1" align="center" bgcolor="green">
<input type='hidden' name='tablenum' value='t9'><input type=submit value='Book'><br>TABLE 9</td>
